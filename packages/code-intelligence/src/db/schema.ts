...
export const embeddingStatus = sqliteTable('embedding_status', {
  ...
  activeDevice: text('active_device'),
  downloadStatus: text('download_status'),
  downloadFile: text('download_file'),
  downloadLoadedBytes: integer('download_loaded_bytes'),
  downloadTotalBytes: integer('download_total_bytes'),
  downloadProgress: integer('download_progress'),
  embeddingRatePerSecond: integer('embedding_rate_per_second'),
  embeddingEtaSeconds: integer('embedding_eta_seconds'),
  status: text('status').notNull(),
